...
In 2015, *Governing: The Future of States and Localities*, published a [report](https://www.governing.com/archive/gentrification-in-cities-governing-report.html) analyzing the landscape of gentrification in across the nation's 50 largest cities. 

Their [methodology](https://www.governing.com/archive/gentrification-report-methodology.html) used to determine tract eligibility is described as follows:
...
- `Higher Education` eligibility threshold = 1, determination threshold = 0.25
...
## Lance Freeman Methodology

## Hammel and Wyly Methodology

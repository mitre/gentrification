...
renderPlot({
  ...
  combined_indicators %>%
    select(YEAR, STATE, COUNTY, `Median Rent`, `Median Household Income, Total`,
...
inputPanel(
  ...
  checkboxInput("mhv", "Include Median Home Value Indicator", value = TRUE),
  
  checkboxInput("rent", "Include Median Rent Indicator", value = TRUE),
  
  checkboxInput("edu", "Include Education Indicator", value = FALSE)

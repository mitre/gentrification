...
```{r}
redlining <- read.csv("data/All_Population_Weighted_HOLC_Grades_pt2_Threshold.csv")
...
```{r}
dp <- read_xlsx("data/LTDB/LTDB_DP.xlsx")
...
```{r}
standard_70 <- read.csv("data/LTDB/LTDB_Std_All_fullcount/LTDB_Std_1970_fullcount.csv")
standard_80 <- read.csv("data/LTDB/LTDB_Std_All_fullcount/LTDB_Std_1980_fullcount.csv")
...
```{r}
tract_70 <- read.dbf("data/LTDB/Map_Data/tract1970Data.dbf")
tract_80 <- read.dbf("data/LTDB/Map_Data/tract1980Data.dbf")
```
